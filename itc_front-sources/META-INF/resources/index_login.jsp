...
<head>
	...
	<script type="text/javascript" src="${basePath}<%=resBase %>itcui/js/itcui.dev.js?ver=${iVersion}"></script>	
	...
	function login()
	{
		...
		if($("#remember_pass").hasClass("itcui_chkbox_checked")){
			ajaxOptions.savepass = 1;
		}
		$.ajax({
			url : "${basePath}login",
			data : ajaxOptions,
...
<body style="margin-top:8px!important">
	...
	<div class="login_box">
		<div class="login_pannel">
			...
			<div class="checkbox_wrap">				
				<span class="itcui_chkbox" id="remember_id" style="float:left"></span>
				<span class="login_chbox_text" style="float:left;margin-left:4px">记住工号</span>
				<span class="login_chbox_text" style="float:right;margin-left:4px" title="为了您的信息安全，请不要在公共电脑上使用该功能">十天内免登录</span>
				<span class="itcui_chkbox" id="remember_pass" style="float:right" title="为了您的信息安全，请不要在公共电脑上使用该功能"></span>
			</div>

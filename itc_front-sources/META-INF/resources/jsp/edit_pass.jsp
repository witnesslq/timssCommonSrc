...
<script>
	...
	$(document).ready(function(){
	    if(authType == "ad"){
	        $("#adAuthInfo").css("display", "block"); //显示  
	        $("#f_pass1").attr("disabled","disabled");
	        $("#f_pass2").attr("disabled","disabled");
	    }
...
<body style="margin:6px">
		...
		<div style="width:100%;font-size:12px" class="bbox">
			...
			<div class="row">
				...
				<div class="col-xs-8">
					...
					<span class="pull-left reghint">6-15位字母或数字</span>
				</div>
			</div>
			<div class="row">
	...
	<div id="adAuthInfo" class="adauthinfo"><span class= "error">当前使用域帐号登录，修改请联系域管理员.</span></div>
</body>
</html>
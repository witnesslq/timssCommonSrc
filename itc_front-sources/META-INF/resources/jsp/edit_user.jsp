...
<body class="bbox">
	<div class="toolbar-with-pager btn-toolbar">
		...
		<div class="btn-group btn-group-sm" id="btnResetPass" style="display:none">
			<button class="btn-default btn" onclick="showEditPass()">重设密码</button>
		</div>
	...
	<div id="site_priv" grouptitle="该站点下的权限">
		<div class="btn-toolbar">
			<div class="btn-group btn-group-xs">
				<button class="btn-default btn" id="btnFold">折叠所有</button>
				<button class="btn-default btn" id="btnExpand">展开所有</button>
			</div>
		</div>
		<div id="tree_wrap">
			<div id="priv_tree">

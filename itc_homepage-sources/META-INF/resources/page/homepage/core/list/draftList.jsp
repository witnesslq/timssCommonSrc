...
<script>
	...
	var url = basePath + "homepage/Info/DraftListInfo.do";
</script>
</head>
<body class="bbox list-page">
			...
			<div id="toolbar1" class="btn-toolbar ">
				...
				<div class="btn-group btn-group-sm">
					<button type="button" class="btn btn-default"
						onclick="homepageServiceImpl.deleteProcess();">删除</button>
				</div>
				<div class="btn-group btn-group-sm">
	...
	<div id="grid_empty" class="row homepage_mi" style="display:none">没有草稿</div>
</body>
</html>
